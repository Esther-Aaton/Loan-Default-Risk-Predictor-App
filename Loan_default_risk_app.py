...
#User Input
# 'referred': ['False'],'bank_account_type','bank_name_clients','employment_status_clients','age_group','payment_status','repayment_ratio'
#'loanamount','totaldue','termdays','avg_credit_score','loan_approval_time_min','loan_counts','max_loan_amount','avg_loan_amount','longitude_gps'
#'latitude_gps'
