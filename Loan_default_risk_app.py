...
loanamount = st.number_input("Loan Amount", 10000, 60000, 30000)
totaldue = st.number_input("Total Due", 10000, 70000, 35000)
termdays = st.slider("Term Days", 15, 90, 30)
avg_credit_score = st.number_input("Credit Score", 300, 850, 600)
loan_approval_time_min = st.slider("Loan Approval Time(min)", 60, 3000, 600)
